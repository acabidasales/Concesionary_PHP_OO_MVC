function load_shop_list(num_pag = 0, num_item = 4) {
    ajaxPromise('module/shop/controller/controller_shop.php?op=Shop_List',
        ...
        .then(function(json) {
            ...
            $(".wrapper").on("click", function() {
                ...
                ajaxPromise("module/shop/controller/controller_shop.php?op=update_count&ID=" + id, 'GET', 'JSON')
                    .then(function() {
...
function load_shop_details(id, loadeds = 0, items = 4) {
    ajaxPromise("module/shop/controller/controller_shop.php?op=Select_Details&ID=" + id, 'GET', 'JSON')
        .then(function(json) {
            $("#shop_list").empty();
            $("#pagination").empty();
            ...
            Element_container.innerHTML =
                "<div id='general' style='margin-left:750px;'><br><br><br><br><br><br><br><fieldset id='contenido_pag'><legend style='color:white;width:auto;'>" + json[0].Marca + " " + json[0].Modelo + "</legend>" +
                ...
                "<tbody>" +
                "<tr style='font-size:26px;margin-top:20px;'><td style='text-align:left;'>Precio: </td><td style='text-align:right;color:red;'>" + json[0].precio + "€" + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Fabricante: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Marca + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Modelo: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Modelo + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Motor: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Motor + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Tipo de Combustible: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Tipo + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Caballos: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Caballos + "CV" + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Numero de Bastidor: </td><td style='text-align:right;padding-right:4px;'>" + json[0].NBast + "</td></tr><br>" +
                "<tr><td style='text-align:left;padding-left:4px;'>Matricula: </td><td style='text-align:right;padding-right:4px;'>" + json[0].Matricula + "</td></tr><br>" +
                ...
                "<div class='list__heart' id='" + json[0].ID + "' style='margin-left:32.5%;'><img id='like_" + json[0].ID + "' class='bx-heart'></div>" +
            ...
            id_principal = json[0].ID;
            ajaxPromise("module/shop/controller/controller_shop.php?op=more_related", 'POST', 'JSON', { 'related': json[0].Marca, 'no_repeat': json[0].ID, 'loadeds': loadeds, 'items': items })
                .then(function(json) {
                    const data = json
...
function filtros(num_pag, num_item) {
    ajaxPromise("module/shop/controller/controller_shop.php?op=print_filter", 'POST', 'JSON')
        .then(function(json) {
            //console.log(json);
...
function home_redirect_filtros(num_pag = 0, num_item = 4) {
    ...
    /*     console.log(filter);
     */
    ajaxPromise('module/shop/controller/controller_shop.php?op=filter', 'POST', 'JSON', { 'filter': filter, num_pag: num_pag, num_item: num_item })
        .then(function(json) {
            $("#shop_list").empty();
            var Element_container = document.createElement('div');
            Element_container.id = "shop_container";
...
function order_redirect(order) {
    ...
    ajaxPromise('module/shop/controller/controller_shop.php?op=order_by&Orden=' + order, 'GET', 'JSON')
        .then(function(json) {
            console.log(json);
            $("#shop_list").empty();
            var Element_container = document.createElement('div');
...
function search_redirect_filtros(data_search) {
    ...
    ajaxPromise('module/shop/controller/controller_shop.php?op=search', 'POST', 'JSON', { 'data_search': data_search })
        .then(function(json) {
            console.log(json);
            $("#shop_list").empty();
            var Element_container = document.createElement('div');
...
function load_pagination() {
    if (localStorage.getItem('filter_marcas') && !localStorage.getItem('filter_combustible')) {
        ...
        var url = "module/shop/controller/controller_shop.php?op=count_filters&datos=" + datos;
...
function load_like() {
    if (localStorage.getItem('token') == null) {
        ...
        $.ajax({
            url: "module/shop/controller/controller_shop.php?op=load_likes&username=" + localStorage.getItem('token'),
            type: 'GET',
            dataType: 'JSON',
...
function click_like() {
    $(document).on('click', '.list__heart', function() {
        if (localStorage.getItem('token') == undefined) {
            ...
            $.ajax({
                url: "module/shop/controller/controller_shop.php?op=control_likes&id=" + this.getAttribute('id') + "&username=" + localStorage.getItem('token'),
                type: 'GET',
                dataType: 'JSON',
            }).done(function(data) {
                console.log(data);
