function loadSlider_marcas() {
    ...
    $.ajax({
        url: "module/home/controller/controller_home.php?op=Home_Marcas",
        type: 'GET',
        dataType: 'JSON',
        success(json) {
...
function loadSlider_categorias() {
    $.ajax({
        url: "module/home/controller/controller_home.php?op=Home_Categorias",
        type: 'GET',
        dataType: 'JSON',
        success(json) {
            var Element_container = document.createElement('section');
...
function loadSlider_tipos() {
    $.ajax({
        url: "module/home/controller/controller_home.php?op=Home_Tipos",
        type: 'GET',
        dataType: 'JSON',
        success(json) {
            var Element_container = document.createElement('section');
